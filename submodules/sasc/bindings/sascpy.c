 ...
 */
  ...
  for (;;) {
    ...
    PyTuple_SET_ITEM(__pyx_t_12, 0, __pyx_v_lb);
 ...
 */
  ...
  for (;;) {
    ...
    __Pyx_INCREF(__pyx_v_lb);
    __Pyx_GIVEREF(__pyx_v_lb);
    PyTuple_SET_ITEM(__pyx_t_13, 0, __pyx_v_lb);
    __Pyx_INCREF(__pyx_n_s_ascii);
    __Pyx_GIVEREF(__pyx_n_s_ascii);
